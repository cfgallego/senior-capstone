//angular.module("app").controller("searchController", ['$scope', 'AppServices', function ($scope, appServices, $http) {
//    var self = this
...
angular.module("app").controller("searchController", ['$scope', 'AppServices', '$http', '$window', '$location', '$filter', '$routeParams', '$rootScope', function ($scope, appServices, $http, $window, $location, $filter, $routeParams, $rootScope) {
    ...
    //    return (angular.lowercase(row.FirstName).indexOf(angular.lowercase($scope.query) || '') !== -1 ||
    //        angular.lowercase(row.LastName).indexOf(angular.lowercase($scope.query) || '') !== -1);
    //}
